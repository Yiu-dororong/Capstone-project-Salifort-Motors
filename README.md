...
```
# I am not sure if this feature means total projects conducted throughout career or just this year
...
A extremely low percent (1.68%) of people who did get a promotion, but a promotion did have its value, lowering the turnover rate.
...
It is hard to retain the first group of people, as they claimed to have a 0.8/1.0 satisfaction level. The reason behind tends to be they just want to change job.
...
Allow projects to be shared accross wider manpower. As observed in the `number_project` graph, people who took up 7 projects all left. This also linked to the next problem, long working hours. Longer working hours definitely result in lower satisfaction level. By sharing projects, it should reduce all these symptoms and make more people stay.

Provide more compensation for being hard-working. Although not proven, my theory to the fraction of people who had encountered work accident turns out to be less likely to leave, is due to there are compensation provided to them, make them feel valued by the company. There should go the same to ovettime. Consider that salary and promotion also affect turnover rate, a better review system is needed to reward people being dilligent.
